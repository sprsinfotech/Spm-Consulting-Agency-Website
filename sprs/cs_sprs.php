...
<!-- Mirrored from demiray.niyz.com/themeforest/gox/index-YOUTUBE.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 17 Aug 2021 02:42:13 GMT -->
...
<body data-overlay-type="dotted" data-theme-color="magentamix">
    ...
    <div id="right">
        ...
        <section id="about" class="about">
            ...
            <p class="description">
                Lorem ipsum dolor sit, amet consectetur adipisicing elit. Harum deserunt fugiat voluptates facilis
                corporis quam hic, non impedit ut eaque perspiciatis assum.
                Lorem ipsum Dolor elit dolor laboris in enim ex ex deserunt consequat irure eu commodo mollit anim
                minim tempor Excepteur
                pariatur sit ut voluptate amet eiusmod aute et occaecat incididunt aute sit cupidatat dolore enim
                proident!
            </p>
            ...
            <div class="about-gox">
                ...
                <!-- 6.1.2.6. Recycle -->
                <div class="text-center">
                    <img src="dist/img/features/recycle.png" alt="Recycle">
                    <h4>Recycle</h4>
                    <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Libero, fuga.</p>
                </div>
            </div>
        ...
        <div class="grid gallery">
            <a href="dist/img/portfolio/img1.jpg" data-lightbox="gallery">
                <figure class="portfolio-effect">
                    <img src="dist/img/portfolio/img1.jpg" alt="img1" />
                    <figcaption></figcaption>
                </figure>
            </a>
            <a href="dist/img/portfolio/img4.jpg" data-lightbox="gallery">
                <figure class="portfolio-effect">
                    <img src="dist/img/portfolio/img4.jpg" alt="img2" />
                    <figcaption></figcaption>
                </figure>
            </a>
            <a href="dist/img/portfolio/img3.jpg" data-lightbox="gallery">
                <figure class="portfolio-effect">
                    <img src="dist/img/portfolio/img3.jpg" alt="img3" />
                    <figcaption></figcaption>
                </figure>
            </a>
            <a href="dist/img/portfolio/img2.jpg" data-lightbox="gallery">
                <figure class="portfolio-effect">
                    <img src="dist/img/portfolio/img2.jpg" alt="img4" />
                    <figcaption></figcaption>
                </figure>
            </a>
        </div>
    ...
    <div id="youtube-bg">
        <a id="bgndVideo" class="player mb_YTPlayer"
            data-property="{videoURL:'Fk9EBOOAYiU',containment:'body', showControls:true, autoPlay:true, loop:true, vol:50, mute:false, startAt:40, stopAt:150, opacity:1, addRaster:true, quality:'hd720'}"
    ...
    <script src="dist/js/scripts.js"></script> <!-- [CUSTOM SETTING] -->
...
<!-- Mirrored from demiray.niyz.com/themeforest/gox/index-YOUTUBE.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 17 Aug 2021 02:42:14 GMT -->
